...
function isHash({ hash, origin, pathname }, location = window.location) {
...
function isPushEvent({ url, anchor, event: { metaKey, ctrlKey } }, location) {
    return (!metaKey &&
        !ctrlKey &&
        shouldLoadAnchor(anchor) &&
        !isExternal(url, location));
}
function isHintEvent({ url, anchor }, location) {
    return (shouldLoadAnchor(anchor) &&
        !isExternal(url, location) &&
        !isHash(url, location));
}
function isHashChange({ url: { pathname: prevPathname } }, { url: { pathname, hash }, cause }) {
...
class ScriptManager {
    ...
    reinsertScriptTags(context) {
        ...
        return from(scripts).pipe(concatMap(script => this.insertScript(script)), catchError(error => of(Object.assign({}, context, { error }))), finalize(() => (document.write = originalWrite)), mapTo(context))
            .toPromise();
    }
...
const timeout$1 = (t) => new Promise(r => setTimeout(r, t));
class EventManager {
    constructor(parent) {
        this.parent = parent;
    }
    ...
    ;
    onStart(context) {
        this.animPromise = timeout$1(this.duration);
        const transitionUntil = (promise) => {
            this.animPromise = promise;
        };
        this.parent.startThing.emit(Object.assign({}, context, { transitionUntil }));
    }
...
let HyPushState = class HyPushState {
    constructor() {
    ...
    componentWillLoad() {
        ...
        const deferred = {};
        const push$ = this.pushEvent$.pipe(
        ...
        const merged$ = merge(push$, pop$, reload$).pipe(
        // HACK: startwith???
        startWith({ url: new URL(this.initialHref) }), tap(({ url }) => (this.url = url)), pairwise(), share());
        ...
        const hint$ = this.prefetch$.pipe(switchMap(prefetch => {
            ...
            // tap(x => console.log(x)),
            // takeUntil(this.subjects.disconnect),
            unsubscribeWhen(pauser$), map(([event, anchor]) => ({
                cause: Cause.Hint,
                url: new URL(anchor.href, this.href),
                anchor,
                event,
...
__decorate([
    Element$1()
], HyPushState.prototype, "el", void 0);
__decorate([
...
__decorate([
    Prop({ type: String, mutable: true })
], HyPushState.prototype, "initialHref", void 0);
__decorate([
    Watch('linkSelector')
], HyPushState.prototype, "setLinkSelector", null);
__decorate([
    Watch('prefetch')
], HyPushState.prototype, "setPrefetch", null);
__decorate([
    Event()
], HyPushState.prototype, "startThing", void 0);
__decorate([
    Event()
], HyPushState.prototype, "ready", void 0);
__decorate([
    Event()
], HyPushState.prototype, "after", void 0);
__decorate([
    Event()
], HyPushState.prototype, "progress", void 0);
__decorate([
    Event()
], HyPushState.prototype, "load", void 0);
__decorate([
    Event()
], HyPushState.prototype, "error", void 0);
__decorate([
    Event()
], HyPushState.prototype, "networkerror", void 0);
__decorate([
    Method()
