...
function defineJQueryComponent(name, Component) {
  ...
  var Constructor = function (_Component) {
    ...
    _createClass(Constructor, [{
      key: "setupShadowDOM",
      value: function setupShadowDOM(el) {
        this.$element = _get(Constructor.prototype.__proto__ || Object.getPrototypeOf(Constructor.prototype), "setupShadowDOM", this).call(this, jquery__WEBPACK_IMPORTED_MODULE_0___default()(el));
        return this.$element[0];
      }
    }, {
      key: "fireEvent",
      value: function fireEvent(eventName, data) {
        var event = jquery__WEBPACK_IMPORTED_MODULE_0___default.a.Event(eventName + "." + ns, data);
  ...
  function plugin(option, arg) {
    ...
    return this.each(function () {
      ...
      if (!data) {
        ...
        var props = jquery__WEBPACK_IMPORTED_MODULE_0___default.a.extend({}, dataProps, (typeof option === "undefined" ? "undefined" : _typeof(option)) === "object" && option);
...
var JQUERY_FEATURE_TESTS = new hy_component_src_define_jquery_component__WEBPACK_IMPORTED_MODULE_0__["Set"]([].concat(_toConsumableArray(_mixin__WEBPACK_IMPORTED_MODULE_1__["MIXIN_FEATURE_TESTS"])));
JQUERY_FEATURE_TESTS.delete("customevent");



Object(hy_component_src_define_jquery_component__WEBPACK_IMPORTED_MODULE_0__["defineJQueryComponent"])("hy.pushstate", function (_pushStateMixin) {
