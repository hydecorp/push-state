    ...
    _createClass(_class, [{
      ...
      value: function onStart(context) {
        ...
        this.fireEvent("start", {
          detail: Object.assign(context, { transitionUntil: transitionUntil })
        });
      }
  ...
  return function (_setupObservablesMixi) {
    ...
    _createClass(_class, [{
      ...
      value: function connectComponent() {
        ...
        this.updateHistoryState({ type: _constants__WEBPACK_IMPORTED_MODULE_6__["INIT"], replace: true, url: url });

        var replaceEls = this.getReplaceElements(document);
        if (Object(_common__WEBPACK_IMPORTED_MODULE_5__["isExternal"])(this)) this.rewriteURLs(replaceEls);
    ...
    _createClass(_class, [{
      ...
      value: function setupObservables() {
        ...
        var hint$ = this.subjects.prefetch.pipe(Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["switchMap"])(function (prefetch) {
          if (!prefetch) return rxjs_esm5__WEBPACK_IMPORTED_MODULE_0__["NEVER"];
          ...
          return _this2.hintSubject.pipe(Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["takeUntil"])(_this2.subjects.disconnect), Object(_operators__WEBPACK_IMPORTED_MODULE_4__["unsubscribeWhen"])(pauser$), Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (event) {
            return {
          ...
          }), Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["filter"])(_this2.isHintEvent.bind(_this2)));
        }));
