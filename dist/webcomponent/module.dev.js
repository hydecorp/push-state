...
var mapResponse =
/*@__PURE__*/
Object(_operators_map__WEBPACK_IMPORTED_MODULE_4__["map"])(function (x, index) {
  return x.response;
});
...
var MIXIN_FEATURE_TESTS = new hy_component_src_component__WEBPACK_IMPORTED_MODULE_0__["Set"]([].concat(_toConsumableArray(hy_component_src_component__WEBPACK_IMPORTED_MODULE_0__["COMPONENT_FEATURE_TESTS"]), ["documentfragment", "eventlistener", "history", "promises", "queryselector", "requestanimationframe"]));
    ...
    function (_C) {
      ...
      _createClass(_class, [{
        ...
        value: function scrollHashIntoView(hash, options) {
          if (hash) {
            var el = document.getElementById(decodeURIComponent(hash.substr(1)));
...
var WEBCOMPONENT_FEATURE_TESTS = new hy_component_src_custom_element__WEBPACK_IMPORTED_MODULE_0__["Set"]([].concat(_toConsumableArray(hy_component_src_custom_element__WEBPACK_IMPORTED_MODULE_0__["CUSTOM_ELEMENT_FEATURE_TESTS"]), _toConsumableArray(_mixin__WEBPACK_IMPORTED_MODULE_1__["MIXIN_FEATURE_TESTS"])));
