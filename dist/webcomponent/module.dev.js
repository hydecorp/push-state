    ...
    _createClass(_class, [{
      ...
      value: function setupComponent(el, opts) {
        ...
        Object.keys(this.constructor.types).map(function (key) {
          _this2.subjects[key] = new rxjs_esm5__WEBPACK_IMPORTED_MODULE_0__["ReplaySubject"](1);
...
var mapResponse = /*@__PURE__*/Object(_operators_map__WEBPACK_IMPORTED_MODULE_6__["map"])(function (x, index) {
    return x.response;
});
        ...
        if ("MutationObserver" in window && "WeakSet" in window) {
          ...
          var addListeners = function addListeners(addedNode) {
            if (addedNode instanceof Element) {
              if (_common__WEBPACK_IMPORTED_MODULE_1__["matches"].call(addedNode, _this2.linkSelector)) {
                addLink(addedNode);
              } else {
          ...
          var removeListeners = function removeListeners(removedNode) {
            if (removedNode instanceof Element) {
              if (_common__WEBPACK_IMPORTED_MODULE_1__["matches"].call(removedNode, _this2.linkSelector)) {
          ...
          rxjs_esm5__WEBPACK_IMPORTED_MODULE_0__["Observable"].create(function (obs) {
          ...
          this.el.addEventListener("click", function (event) {
            var anchor = _common__WEBPACK_IMPORTED_MODULE_1__["matchesAncestors"].call(event.target, _this2.linkSelector);
  ...
  return function (_C) {
    ...
    _createClass(_class, [{
      ...
      value: function onStart(context) {
        ...
        this.animPromise = Object(rxjs_esm5__WEBPACK_IMPORTED_MODULE_0__["timer"])(this.duration);
    ...
    _createClass(_class, [{
      ...
      value: function recoverIfResponse(context, error) {
        ...
        if (xhr && xhr.response && status > 400 && status < 598) {
          return Object(rxjs_esm5__WEBPACK_IMPORTED_MODULE_0__["of"])(Object.assign(context, { response: xhr.response }));
        }

        // If we don't have a response, this is an acutal error that should be dealt with.
        return Object(rxjs_esm5__WEBPACK_IMPORTED_MODULE_0__["of"])(Object.assign(context, { error: error }));
      }
...
/* harmony import */ var rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! rxjs/_esm5/operators */ "./node_modules/rxjs/_esm5/operators/index.js");
/* harmony import */ var _url__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../url */ "./src/url.js");
/* harmony import */ var _common__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../common */ "./src/common.js");
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./constants */ "./src/mixin/constants.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "INIT", function() { return _constants__WEBPACK_IMPORTED_MODULE_7__["INIT"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "HINT", function() { return _constants__WEBPACK_IMPORTED_MODULE_7__["HINT"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "PUSH", function() { return _constants__WEBPACK_IMPORTED_MODULE_7__["PUSH"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "POP", function() { return _constants__WEBPACK_IMPORTED_MODULE_7__["POP"]; });

/* harmony import */ var _setup__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./setup */ "./src/mixin/setup.js");
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
  ...
  return function (_setupObservablesMixi) {
    ...
    _createClass(_class, [{
      ...
      value: function connectComponent() {
        ...
        var url = new _url__WEBPACK_IMPORTED_MODULE_5__["URL"](this.initialHref);
        this.updateHistoryState({ type: _constants__WEBPACK_IMPORTED_MODULE_7__["INIT"], replace: true, url: url });

        var replaceEls = this.getReplaceElements(document);
        if (Object(_common__WEBPACK_IMPORTED_MODULE_6__["isExternal"])(this)) this.rewriteURLs(replaceEls);
        ...
        this.onLoad({
          type: _constants__WEBPACK_IMPORTED_MODULE_7__["INIT"],
      ...
      value: function assign(url) {
        this.reload$.next({
          type: _constants__WEBPACK_IMPORTED_MODULE_7__["PUSH"],
          url: new _url__WEBPACK_IMPORTED_MODULE_5__["URL"](url, this.href),
      ...
      value: function reload() {
        this.reload$.next({
          type: _constants__WEBPACK_IMPORTED_MODULE_7__["PUSH"],
          url: new _url__WEBPACK_IMPORTED_MODULE_5__["URL"](this.href),
          cacheNr: ++this.cacheNr, // eslint-disable-line no-plusplus
          replace: true
        });
      }
    ...
    return _class;
  }(Object(_setup__WEBPACK_IMPORTED_MODULE_8__["setupObservablesMixin"])(Object(hy_component_src_rxjs__WEBPACK_IMPORTED_MODULE_1__["rxjsMixin"])(Object(hy_component_src_component__WEBPACK_IMPORTED_MODULE_0__["componentMixin"])(C))));
};
...
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./constants */ "./src/mixin/constants.js");
var _slicedToArray = function () { function sliceIterator(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"]) _i["return"](); } finally { if (_d) throw _e; } } return _arr; } return function (arr, i) { if (Array.isArray(arr)) { return arr; } else if (Symbol.iterator in Object(arr)) { return sliceIterator(arr, i); } else { throw new TypeError("Invalid attempt to destructure non-iterable instance"); } }; }();
  ...
  return function (_C) {
    ...
    _createClass(_class, [{
      ...
      value: function isHashChange(_ref3) {
        ...
        return pathname === prevPathname && (type === _constants__WEBPACK_IMPORTED_MODULE_2__["POP"] || type === _constants__WEBPACK_IMPORTED_MODULE_2__["PUSH"] && hash !== "");
      }
    }]);
...
var unsubscribeWhen = function unsubscribeWhen(pauser$) {
  return function (source) {
    ...
    return pauser$.pipe(Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["switchMap"])(function (paused) {
      return paused ? Object(rxjs_esm5__WEBPACK_IMPORTED_MODULE_0__["never"])() : source;
    }));
  };
};
  ...
  return function (_eventListenersMixin) {
    ...
    _createClass(_class, [{
      ...
      value: function setupObservables() {
        ...
        this.hintSubject = new rxjs_esm5__WEBPACK_IMPORTED_MODULE_0__["Subject"]();
        ...
        var push$ = this.pushSubject.pipe(Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["takeUntil"])(this.subjects.disconnect), Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (event) {
          return {
            ...
            url: new _url__WEBPACK_IMPORTED_MODULE_2__["URL"](event.currentTarget.href, _this2.href),
        ...
        var pop$ = Object(rxjs_esm5__WEBPACK_IMPORTED_MODULE_0__["fromEvent"])(window, "popstate").pipe(Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["takeUntil"])(this.subjects.disconnect), Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["filter"])(function () {
          ...
          return {
            ...
            url: new _url__WEBPACK_IMPORTED_MODULE_2__["URL"](window.location, _this2.href),
            event: event,
            cacheNr: _this2.cacheNr
          };
        }));

        var reload$ = this.reload$.pipe(Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["takeUntil"])(this.subjects.disconnect));

        // TODO: doc

        var _merge$pipe$map = Object(rxjs_esm5__WEBPACK_IMPORTED_MODULE_0__["merge"])(push$, pop$, reload$).pipe(Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["startWith"])({ url: new _url__WEBPACK_IMPORTED_MODULE_2__["URL"](this.initialHref) }),
        ...
        var pauser$ = Object(rxjs_esm5__WEBPACK_IMPORTED_MODULE_0__["defer"])(function () {
          return (
            ...
            Object(rxjs_esm5__WEBPACK_IMPORTED_MODULE_0__["merge"])(page$.pipe(Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["mapTo"])(true)), _this2.fetch$.pipe(Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["mapTo"])(false)))
          );
        })
        ...
        // TODO: doc
        var hint$ = this.hintSubject.pipe(Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["takeUntil"])(this.subjects.disconnect), Object(_operators__WEBPACK_IMPORTED_MODULE_4__["unsubscribeWhen"])(pauser$), Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (event) {
          return {
        ...
        }), Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["filter"])(this.isHintEvent.bind(this)));

        // The stream of (pre-)fetch events.
        // Includes definitive page change events do deal with unexpected page changes.
        var prefetch$ = Object(rxjs_esm5__WEBPACK_IMPORTED_MODULE_0__["merge"])(hint$, page$).pipe(
        // Don't abort a request if the user "jiggles" over a link
        Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["distinctUntilChanged"])(this.compareContext.bind(this)), Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["switchMap"])(this.makeRequest.bind(this)),
        // Start with some value so `withLatestFrom` below doesn't "block"
        Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["startWith"])({ url: {} }), Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["share"])());
        ...
        }), Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["withLatestFrom"])(prefetch$), Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["switchMap"])(this.getResponse.bind(this, prefetch$)), Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["share"])());

        // TODO: doc

        var _fetch$$pipe = this.fetch$.pipe(Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["partition"])(function (_ref5) {
          var error = _ref5.error;
          return !error;
        })),
            _fetch$$pipe2 = _slicedToArray(_fetch$$pipe, 2),
        ...
        }), Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["tap"])({ error: function error(e) {
        ...
        Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["switchMap"])(this.reinsertScriptTags.bind(this)), Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["tap"])({ error: function error(e) {
        ...
        page$.pipe(Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["switchMap"])(function (context) {
          ...
          }).pipe(Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["takeUntil"])(_this2.fetch$), Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["mapTo"])(context));
  ...
  return function (_scriptMixin) {
    ...
    _createClass(_class, [{
      ...
      value: function responseToContent(context) {
        ...
        var fragment = Object(_common__WEBPACK_IMPORTED_MODULE_0__["fragmentFromString"])(response);
...
var HyPushStateElement = function (_customElementMixin) {
  ...
  function HyPushStateElement() {
    ...
    return _possibleConstructorReturn(this, (HyPushStateElement.__proto__ || Object.getPrototypeOf(HyPushStateElement)).apply(this, arguments));
  }
