var _initialized, _scrollManager, _historyManager, _fetchManager, _updateManager, _eventManager, _url, _setLocation, _cacheNr, _reload$, _response$, _upgrade;
...
_initialized = new WeakMap(), _scrollManager = new WeakMap(), _historyManager = new WeakMap(), _fetchManager = new WeakMap(), _updateManager = new WeakMap(), _eventManager = new WeakMap(), _url = new WeakMap(), _setLocation = new WeakMap(), _cacheNr = new WeakMap(), _reload$ = new WeakMap(), _response$ = new WeakMap(), _upgrade = new WeakMap();
__decorate([
